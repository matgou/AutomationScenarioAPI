...
public class ScenarioCallerTest {
	...
	public void emptyTestFirefox() {
		if (System.getProperty("os.name").contains("indow")) {
			String scenarioFilePath = this.getClass().getClassLoader().getResource("scenario/emptyScenario.xml")
					.getPath();
			String osAppropriatePath = System.getProperty("os.name").contains("indow") ? scenarioFilePath.substring(1)
					: scenarioFilePath;
